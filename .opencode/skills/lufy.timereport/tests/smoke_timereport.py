...
REQUIRED = ["LUFY Developer Impact Report", "Propiedades de la tarea", "Resumen ejecutivo", "Impacto diario", "Tiempo IA activo", "Tiempo humano activo", "Paso a paso", "Qué se hizo", "Por qué", "IA", "Humano", "Aprendizajes y pivots", "LOC neto", "Commits", "Tool calls", "Top tools", "Subagents", "Skills", "Fases / timeline", "Stack detectado", "Metodología y limitaciones"]
