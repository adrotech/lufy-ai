# surface-aware-execution Specification

## Purpose

Convertir el perfil descriptivo de superficies del proyecto en un plan read-only, determinístico y explicable para routing, contratos y validación.
