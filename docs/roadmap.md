...
Este roadmap captura trabajo futuro taggeable derivado del análisis comparativo con `Gentleman-Programming/gentle-ai`. El alcance real de `lufy-ai` sigue siendo un kit OpenCode/OpenSpec instalable en repositorios destino, no un producto Go multiagente ni una CLI productizada completa.
...
| `RM-006` | Existe workflow en `.github/workflows/` con shellcheck, JSON validation y test de instalación en temp dir. |
